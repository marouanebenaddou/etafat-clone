...
const PILLARS: Pillar[] = [
  {
    ...
    skills: [
      ...
      { title: "Plans parcellaires & emprises", icon: "ph:grid-four-duotone", slug: "plans-parcellaires-et-emprises" },
      { title: "Cartographie foncière", icon: "ph:map-trifold-duotone", slug: "cartographie-fonciere" },
      { title: "SIG foncier & bases cadastrales", icon: "ph:database-duotone", slug: "sig-foncier-et-bases-cadastrales" },
    ],
  },
  {
    letter: "B",
    ...
    skills: [
      { title: "Relevés terrestres", icon: "ph:mountains-duotone", slug: "topographie-et-geodesie" },
      { title: "Relevés aériens", icon: "ph:airplane-tilt-duotone", slug: "releves-aeriens-et-lidar" },
      { title: "Relevés souterrains", icon: "tabler:radar-2", slug: "georadar-et-detection-de-reseaux" },
      { title: "Relevés bathymétriques", icon: "ph:waves-duotone", slug: "bathymetrie-et-hydrographie" },
      { title: "Relevés de haute précision", icon: "ph:crosshair-simple-duotone", slug: "scanner-laser-3d-et-mms" },
    ],
  },
  {
    letter: "C",
    ...
    skills: [
      ...
      { title: "Webmapping & plateformes géospatiales", icon: "ph:network-duotone", slug: "webmapping-et-plateformes-geospatiales" },
      { title: "Dématérialisation & structuration de données", icon: "ph:folder-open-duotone", slug: "dematerialisation-et-structuration-de-donnees" },
    ],
  },
  {
    letter: "D",
